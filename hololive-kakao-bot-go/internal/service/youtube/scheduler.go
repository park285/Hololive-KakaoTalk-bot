...
func NewYouTubeScheduler(youtube *YouTubeService, cache *cache.CacheService, statsRepo *YouTubeStatsRepository, membersData domain.MemberDataProvider, logger *zap.Logger) *YouTubeScheduler {
