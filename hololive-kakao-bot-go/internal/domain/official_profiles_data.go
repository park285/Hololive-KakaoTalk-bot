...
// LoadOfficialProfiles loads the pre-fetched official talent profiles from the embedded JSON files.
func LoadOfficialProfiles() (map[string]*TalentProfile, error) {
